...
public class GroupLocalServiceWrapper
	...
	public java.util.List<Group> getUserGroups(
		...
		return _groupLocalService.getUserGroups(userId, inherit, isSite);
	}
	...
	public java.util.List<Group> getUserGroups(
		...
		return _groupLocalService.getUserGroups(
			userId, inherit, isSite, start, end);
	}
	 ...
	 */
	@Override
	public java.util.List<Group> getUserGroups(long userId, int start, int end)
		throws com.liferay.portal.kernel.exception.PortalException {
